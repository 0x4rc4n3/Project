...
* [ ] **1.1 Flask Crypto Service (`components/crypto/crypto-service/`)**
...
* [ ] **1.2 Verification API Gateway (`components/verification-api/`)**
...
* [ ] **4.1 Custom Chaincode & Network Setup (`components/blockchain/`)**
